...
const foodData = [
    ...
    },
    {
        ...
        flag: "🇩🇪",
        foods: [
            { name: "Bratwurst", img: "https://images.unsplash.com/photo-1604908176997-125f25f9f9fd?auto=format&fit=crop&w=500&q=60", desc: "Grilled or pan-fried sausage, usually pork or veal, seasoned with herbs and spices. Famous in Germany for its hearty flavor.", why: "It’s a classic street and festival food." },
            { name: "Schnitzel", img: "https://images.unsplash.com/photo-1604908554027-866b7a4e0a0a?auto=format&fit=crop&w=500&q=60", desc: "Thin meat cutlet breaded and fried until golden and crispy. Famous in Vienna/Germany-style beer halls.", why: "The crunchy coating and tender meat are perfect together." },
            { name: "Currywurst", img: "https://images.unsplash.com/photo-1521302080322-5d6d3f1c3b6b?auto=format&fit=crop&w=500&q=60", desc: "Bratwurst topped with curry ketchup and spices. Famous in Berlin street food culture.", why: "A tangy, sweet-spicy sauce makes it instantly recognizable." },
            { name: "Sauerkraut", img: "https://images.unsplash.com/photo-1542014749744-5e65a2e8f1e5?auto=format&fit=crop&w=500&q=60", desc: "Fermented cabbage with a tangy, sour bite. Famous as an everyday German side dish.", why: "Fermentation gives it depth and a signature acidity." },
            { name: "Braten", img: "https://images.unsplash.com/photo-1600891964094-efb4c5b4e4d0?auto=format&fit=crop&w=500&q=60", desc: "Roasted meats (often pork or beef) served with rich pan gravy. Famous in traditional German Sunday meals.", why: "Slow roasting creates rich flavor and tender texture." },
            { name: "Kartoffelsalat", img: "https://images.unsplash.com/photo-1523986371872-9d3ba2e2a6d3?auto=format&fit=crop&w=500&q=60", desc: "German potato salad served creamy or vinaigrette-style depending on region. Famous at picnics and gatherings.", why: "It’s comforting and pairs perfectly with grilled sausages." },
