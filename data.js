...
const foodData = [
    ...
    },
    {
        ...
        foods: [
            ...
            { name: "Schnitzel", img: "https://media.istockphoto.com/id/1329294505/photo/delicious-original-schnitzel.jpg?s=612x612&w=0&k=20&c=zpJJ1UgKI6FzxbJdtV6n0Xrai6wWd0jwK6_h3325tZs=", desc: "Thin meat cutlet breaded and fried until golden and crispy. Famous in Vienna/Germany-style beer halls.", why: "The crunchy coating and tender meat are perfect together." },
            { name: "Currywurst", img: "https://media.istockphoto.com/id/540971474/photo/traditional-german-currywurst-served-with-chips-on-disposable-p.jpg?s=612x612&w=0&k=20&c=j7qGtCaFFnonEE9mvLaY26K7CJ-f-OQyEo9TC_EN1Hs=", desc: "Bratwurst topped with curry ketchup and spices. Famous in Berlin street food culture.", why: "A tangy, sweet-spicy sauce makes it instantly recognizable." },
            { name: "Sauerkraut", img: "https://media.istockphoto.com/id/1431365387/photo/homemade-sauerkraut.jpg?s=612x612&w=0&k=20&c=d-JZykwF43TG86Fao4PRRbF3fkq9w56PLJprrn3W7qY=", desc: "Fermented cabbage with a tangy, sour bite. Famous as an everyday German side dish.", why: "Fermentation gives it depth and a signature acidity." },
            { name: "Braten", img: "https://media.istockphoto.com/id/626839426/photo/beef-roulade-with-red-cabbage-and-dumplings.jpg?s=612x612&w=0&k=20&c=7XHt4S8gWXscreJYjCRozwSnYeLEb6nCaAjv49I3CfU=", desc: "Roasted meats (often pork or beef) served with rich pan gravy. Famous in traditional German Sunday meals.", why: "Slow roasting creates rich flavor and tender texture." },
            { name: "Kartoffelsalat", img: "https://media.istockphoto.com/id/894463918/photo/potato-salad-with-eggs-and-green-onion.jpg?s=612x612&w=0&k=20&c=nXUoKYZZFphDNM0YDTsQ3YTZfcz_sqVLMl8CMKMNrYk=", desc: "German potato salad served creamy or vinaigrette-style depending on region. Famous at picnics and gatherings.", why: "It’s comforting and pairs perfectly with grilled sausages." },
            { name: "Käsespätzle", img: "https://media.istockphoto.com/id/1167922878/photo/alpine-cheese-sp%C3%A4tzle-served-in-an-iron-pan.jpg?s=612x612&w=0&k=20&c=IBE3VuLTPmLdRyCbCOemt6yv59X4hSqraJ0WNq31eAE=", desc: "Swabian egg noodles tossed with melted cheese, often topped with onions. Famous in southern Germany.", why: "Cheesy noodles are the ultimate comfort dish." },
    ...
    },
    {
        ...
        flag: "🇰🇷",
        foods: [
            { name: "Kimchi", img: "https://media.istockphoto.com/id/1067659814/photo/homemade-kimchee.jpg?s=612x612&w=0&k=20&c=IasHde8RFaJ06cGtDjWbjzF9MxzkpQIXUboH5cAa6Uw=", desc: "Fermented spicy vegetables, usually napa cabbage or radish. Famous as a staple side dish in Korea.", why: "It adds tang, heat, and umami to almost any meal." },
            { name: "Bibimbap", img: "https://media.istockphoto.com/id/2178216883/photo/traditional-korean-dish-bibimbap-with-rice-vegetables-beef-and-egg-in-a-white-plate.jpg?s=612x612&w=0&k=20&c=P_In7Tisc4YwFSZobEd0bFh2qR99m4n3w4rGqKtWUhc=", desc: "Rice bowl topped with assorted vegetables, meat (optional), and a gochujang sauce. Famous for its colorful toppings.", why: "Mixing everything creates a perfect balance of flavors." },
            { name: "Bulgogi", img: "https://media.istockphoto.com/id/926774114/photo/homemade-barbecue-korean-beef-bulgogi.jpg?s=612x612&w=0&k=20&c=wTbZll3O8L9_4YF-3ZXeIFtaGbMxtvJqMIEJ-JsdFQ0=", desc: "Marinated grilled beef (sometimes pork) sweet-savory in flavor. Famous for its caramelized edges.", why: "The marinade tenderizes and boosts deep flavor." },
            { name: "Tteokbokki", img: "https://media.istockphoto.com/id/1245320768/photo/homemade-tteokbokki-or-spicy-korean-rice-cake-is-one-of-the-most-popular-korean-street-foods.jpg?s=612x612&w=0&k=20&c=t895XgRCFc3aHWvoKaZFae2wTJ5KHGve2OpajzR18V8=", desc: "Chewy rice cakes cooked in a spicy-sweet gochujang sauce. Famous street food.", why: "The sauce clings perfectly and keeps you coming back." },
            ...
            { name: "Korean Fried Chicken", img: "https://media.istockphoto.com/id/183889526/photo/close-up-of-fried-chicken-wings-sprinkled-with-sesame.jpg?s=612x612&w=0&k=20&c=It3IMqp1hBTT_oLmYrKNewkgISHzSHzfamhWU8_ct5M=", desc: "Double-fried crispy chicken often coated with soy-garlic or spicy sauce. Famous across Korea and beyond.", why: "Extra crunch and sticky glaze create a satisfying bite." },
            ...
            { name: "Gimbap", img: "https://media.istockphoto.com/id/2079560425/photo/gimbab-roll-made-from-steamed-white-rice-and-various-other-ingredients-rolled-korean-street.jpg?s=612x612&w=0&k=20&c=pjaIFsyly3jiE20pj-MgR6YGURpR1OQo3rl5519byLk=", desc: "Korean seaweed rice rolls filled with vegetables, egg, and often meat or tuna. Famous for lunch boxes.", why: "Portable, flavorful, and easy to love." }
        ]
    },
    {
        country: "Turkey",
        flag: "🇹🇷",
        foods: [
            { name: "Döner Kebab", img: "https://media.istockphoto.com/id/499844279/photo/cook-preparing-a-turkish-doner-kebab.jpg?s=612x612&w=0&k=20&c=vE95aRnutptw7jtOIFJJtQ7ViquX2B73rSHflfsUGhQ=", desc: "Sliced roasted meat served in bread or plate with sauces and salad. Famous street food from Turkey.", why: "The rotating spit roasting creates rich flavor." },
            ...
            { name: "Baklava", img: "https://media.istockphoto.com/id/183422455/photo/perfect-baklava-with-pistachio-arranged-on-a-white-plate.jpg?s=612x612&w=0&k=20&c=PrqSbfqsNKkLa1U9CNi6M2aT4pV98aDxX2_cQiqOxo0=", desc: "Layered filo pastry with nuts and syrup/honey. Famous dessert in Turkish cuisine.", why: "The crisp layers and sweet syrup are a perfect match." },
            { name: "Turkish Tea (Çay)", img: "https://media.istockphoto.com/id/1280227708/photo/glass-cup-of-brewed-black-turkish-tea-pouring-from-teapot-traditional-hot-drink-concept.jpg?s=612x612&w=0&k=20&c=dyVrC07vXtEcVcA1hgLXl-SV3lcd6eeORXEi2gWBbfc=", desc: "Strong black tea served in small tulip-shaped glasses. Famous daily ritual.", why: "It’s social, comforting, and essential to Turkish culture." },
